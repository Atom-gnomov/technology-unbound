...
**0.3.0 (текущая)** — тир **T2** целиком: **закалённый таумий** (два пути —
домна IC2 и тигель), броня и полный сет инструментов из него, таумиевый
ключ, электрочернильница, **Фиал-станция** и **Эссент. Горелка** (первые
блоки мода на эссенции). Заодно код приведён к канону там, где отстал:
курс Сингулятора 10 000, рецепты конвертеров пересчитаны калибровкой,
корпус конвертеров — закалённый таумий.
