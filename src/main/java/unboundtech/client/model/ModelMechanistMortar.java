...
public class ModelMechanistMortar extends ModelBase {
    ...
    public ModelMechanistMortar() {
        // 128x128: развёртки НЕ влезали в 64 по высоте и валились
        // друг на друга (ревью №11) — теперь у каждого бокса своя
        ...
        // тумба-крест
        this.base.setTextureOffset(0, 0).addBox(-7.0F, 32.0F, -5.0F, 14, 12, 10);   // тумба-X
        this.base.setTextureOffset(48, 0).addBox(-5.0F, 32.0F, -7.0F, 10, 12, 14);
        // погон — латунное кольцо на талии
        this.base.setTextureOffset(0, 26).addBox(-8.0F, 30.0F, -8.0F, 16, 2, 16);
        // патронный короб с крышкой
        this.base.setTextureOffset(96, 0).addBox(7.0F, 36.0F, -2.5F, 8, 7, 5);
        this.base.setTextureOffset(96, 12).addBox(6.5F, 35.0F, -3.0F, 9, 1, 6);
        // кабель-ввод MV сзади
        this.base.setTextureOffset(96, 19).addBox(-2.0F, 40.0F, 7.0F, 4, 3, 3);
        ...
        this.autoLamp = new ModelRenderer(this, 32, 92);
        ...
        this.yawGroup.setTextureOffset(0, 44).addBox(-8.0F, -3.5F, -7.0F, 16, 3, 14);
        // цапфы-щёки: внутренние грани на ±6 — труба 10 проходит
        this.yawGroup.setTextureOffset(60, 44).addBox(6.0F, -12.0F, -4.0F, 3, 9, 8);
        this.yawGroup.setTextureOffset(60, 44).addBox(-9.0F, -12.0F, -4.0F, 3, 9, 8);
        // латунный маховик наведения на правой щеке
        this.yawGroup.setTextureOffset(82, 44).addBox(9.0F, -9.5F, -0.5F, 1, 5, 5);
        this.yawGroup.setTextureOffset(94, 44).addBox(10.0F, -7.5F, 0.5F, 2, 1, 1);
